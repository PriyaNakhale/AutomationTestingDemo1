...
public class ActionClass {
	...
	public static void clickOnRadioButton(List<WebElement> radios, String value) {
	...
	public static void clickOnCheckBox(List<WebElement> checkBoxes, String values) {
	...
	public static void selectFromDropdownList(WebElement elementToClick, List<WebElement> listElements, String values) {
		String[] valuesSplit = values.split(",");
		List<String> list = new ArrayList<String>(Arrays.asList(valuesSplit));
	...
	public static void clickOnGroupElement(List<WebElement> elelist, String value) {
